                    ...
                    <div class="col-sm-12">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <input id="emailForm" type="email" class="form-control" placeholder="Enter Email"
                                       name="email"
                                       required>
                            </div>
                            <div class="form-group row">
                                <label for="passwordForm"><b>Password</b></label>
                                <input id="passwordForm" type="password" class="form-control"
                        ...
                        <p>Sign in with <a href="/login/google">Google</a></p>
                    </div>
                </div>
            </div>
        </div>
